  ...
  (function($) {
    ...
    var AsScrollable = (function() {
      function AsScrollable(element, options) {
        ...
        this.easing =
          $.asScrollbar.getEasing(this.options.easing) ||
          $.asScrollbar.getEasing('ease');
            ...
            value: function bindEvents() {
              ...
              if (this.options.showOnHover) {
                if (this.options.showOnBarHover) {
                  ...
                  this.$element.on(
                    NAMESPACE$1 + '::hover',
                    $.proxy(this.showBar, this)
                  );
                  this.$element.on(
                    NAMESPACE$1 + '::hovered',
                    $.proxy(this.hideBar, this)
                  );
                }
              }
              ...
              this.$container.on(this.eventName('scroll'), function() {
                if (that.horizontal) {
                  ...
                  if (oldLeft !== that.offsetLeft) {
                    ...
                    if (
                      that.offsetLeft === that.getScrollLength('horizontal')
                    ) {
    ...
    var OtherAsScrollable = $.fn.asScrollable;
